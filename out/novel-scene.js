...
novel.Novel.prototype.Load = function(data) {
}
novel.Novel.prototype.GameOver = function(cb) {
}
...
noveldata.SceneData = function() { }
noveldata.SceneData.__name__ = ["noveldata","SceneData"];
noveldata.SceneData.prototype.__class__ = noveldata.SceneData;
List = function(p) {
	if( p === $_ ) return;
	this.length = 0;
}
...
specfactory.NovelFactory.AnimationData = function(type) {
	var output = { image_data : null, image_id : null, image_path : null, text_data : null, text_id : null, text_path : null, div_id : null, div_path : null};
	switch(type) {
	case "image":
